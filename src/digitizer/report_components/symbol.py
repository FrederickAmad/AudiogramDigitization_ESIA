...
class Symbol(object):
    ...
    def __init__(self, symbol_dict: dict, audiogram_coordinates: dict, correction_angle: float):
        ...
        self.symbol_confidence = symbol_dict["confidence"]
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "confidence": self.symbol_confidence,
            "response": True,
            "measurementType": self.measurement_type
        }
        
    def __str__(self):
        return f"Threshold(ear={self.ear}, conduction={self.conduction}, symbol={self.symbol_confidence})"
